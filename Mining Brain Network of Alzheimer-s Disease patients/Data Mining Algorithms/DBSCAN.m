fid = fopen('D:\IUPUI\DataMining\Project\MCI_2.csv', 'r');
P=csvread(fid);



function [C, ptsC, centres,neighbourPts] = dbscan(P, E, minPts)
    ...
    [C, ptsC, centres,neighbourPts] = dbscan(P,10, 10);
    figure;
    plot(centres(:,1),"ro", "markersize", 10, "linewidth", 3); hold on;
    plot(ptsC(:,1),"bo", "markersize", 10, "linewidth", 3); hold on;
